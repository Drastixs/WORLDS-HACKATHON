...
test("the original van prompt puts its rear toward the camera and fits the guide", () => {
...
test("the corrected van prompt puts its front toward the camera and matches the front plane", () => {
