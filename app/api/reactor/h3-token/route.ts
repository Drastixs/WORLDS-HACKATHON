// Isolated H3 capability experiment; keep the production X2 token scope unchanged.
const MODELS = ["reactor/h3-reference-to-video-turbo-realtime"];
      ...
      authorization_details: [
        {
          ...
          constraints: { max_sessions: 1, max_session_duration_seconds: 240 },
        },
      ],
    }),
    cache: "no-store",
