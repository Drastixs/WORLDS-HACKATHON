...
import { MovingCar } from "../components/witness/moving-car";
  ...
  return (
    <main className={entered ? "experience experience--entered" : "experience"}>
      ...
      {entered && status === "ready" ? (
        <>
          <StaticVanLayer viewer={viewerRef.current} visible={playback.stepIndex <= 2} controls={playback.stepIndex === 0} debug={debugVisible} onDebugChange={setDebugVisible} />
          <MovingPerson viewer={viewerRef.current} scene={playback.scene} loopTimeMs={playback.loopTimeMs} durationMs={playback.step.durationMs} visible={playback.stepIndex === 1 || playback.stepIndex === 2} controls={playback.stepIndex === 1} frozen={playback.stepIndex === 2} debug={debugVisible} onDebugChange={setDebugVisible} />
          <MovingCar viewer={viewerRef.current} scene={playback.scene} loopTimeMs={playback.loopTimeMs} durationMs={playback.step.durationMs} visible={playback.stepIndex === 2} debug={debugVisible} onDebugChange={setDebugVisible} />
          {playback.stepIndex > 2 && <><X2Overlay poseRef={poseRef} sceneRevision={sceneRevision} />
          <WitnessControls
            debug={debugVisible}
